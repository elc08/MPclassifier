...
class signature_model:
    ''' Define a signature model class that will be filled when trained '''
...
class signature_classifier:
    '''signature classifier is class defined to store entire projects,
       train projects and share them.
       '''

    def __init__(self, vcf, positive=None, negative=None,
                 project_name='MSclassifier', reference_genome='GRCh38',
                 exome=False, feature_list=['SBS96', 'ID83', 'DBS78'],
